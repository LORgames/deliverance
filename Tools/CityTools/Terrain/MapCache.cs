...
namespace CityTools.Terrain {
    public class MapCache {
        ...
        public static void VerifyCacheFiles() {
            ...
            if (!Directory.Exists("mapcache")) Directory.CreateDirectory("mapcache");
        ...
        public static void Fetchmap(int mX, int mY, int wX, int wY, ref Rectangle cachedMapArea, int tries = 0) {
            ...
            if (wX > MainWindow.TILE_TX) wX = MainWindow.TILE_TX - 1;
            if (wY > MainWindow.TILE_TY) wY = MainWindow.TILE_TY - 1;
        ...
        public static void SaveMap() {
            ...
            mapFile.AddInt(MainWindow.TILE_TX);
            mapFile.AddInt(MainWindow.TILE_TY);
            ...
            mapFile.Encode("maptest.map");
        }

        public static string GetTileFilename(int i, int j) {
            return MAP_CACHE + j + MAP_SEPERATOR + i + MAP_FILETYPE;
        }

        internal static void ReleaseAll() {
            Rectangle cachedMapArea = MainWindow.instance.cachedMapArea;
